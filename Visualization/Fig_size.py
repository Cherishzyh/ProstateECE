...
def DmaxPPV(store_format='jpg', fontsize=12, fontsize_legend=14, s=100, is_save=False, store_path=r''):
...
def RISKPPV(store_format='jpg', fontsize=12, fontsize_legend=14, s=100, is_save=False, store_path=r''):
...
def PIRADSPPV(store_format='jpg', fontsize=12, fontsize_legend=14, s=100, is_save=False, store_path=r''):
    # PPV for PIRADS
...
def DmaxNPV(store_format='jpg', fontsize=12, fontsize_legend=14, s=100, is_save=False, store_path=r''):
...
def RISKNPV(store_format='jpg', fontsize=12, fontsize_legend=14, s=100, is_save=False, store_path=r''):
...
def PIRADSNPV(store_format='jpg', fontsize=12, fontsize_legend=14, s=100, is_save=False, store_path=r''):
    # PPV for PIRADS
    store_path = os.path.join(store_path, 'pirads_npv')
    x_labels = ['PIRADS=3\n', 'PIRADS=4\n', 'PIRADS=5\n']
    color_list1 = sns.color_palette('muted')

    fig, ax = plt.subplots(figsize=(2.28, 1.71))
    ax.set_title('NPV', fontsize=fontsize_legend)
    ...
    ax.set_yticklabels(['60%', '70%', '80%', '90%', '100%'], fontsize=fontsize_legend)

    ax.set_xlim(2.5, 3.5)
    ax.set_xticks([2.70, 3.0, 3.30])
    ax.set_xticklabels(x_labels, fontsize=fontsize_legend)
...
if __name__ == '__main__':
    ...
    PIRADSNPV(fontsize=fontsize, s=50, is_save=is_save, store_format=store_format, store_path=store_path)
